...
使用`ps-*`和`pe-*`实用程序来设置`padding-inline-start`和`padding-inline-end`[逻辑属性](https://developer.mozilla.org/en-US/docs/Web/CSS/CSS_Logical_Properties/Basic_concepts)，它们根据文本方向映射到左侧或右侧。
