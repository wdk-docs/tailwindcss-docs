  ...
  return (
    <section id="modern-features">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-indigo-500 dark:text-indigo-400">现代功能</Caption>
        <BigText>
          <Widont>前沿是我们的舒适区。</Widont>
        </BigText>
        <Paragraph as="div">
          <p>
            毫无疑问，Tailwind是现代的，它利用了所有最新和最伟大的CSS特性，使开发人员的体验尽可能愉快。
          </p>
          <p>
            我们有一流的CSS网格支持，由CSS变量驱动的可组合变换和渐变，支持现代状态选择器，如{' '}
            <InlineCode>:focus-visible</InlineCode>, 还有更多。
          </p>
        </Paragraph>
        <Link href="/docs/grid-template-columns" color="indigo" darkColor="gray">
          了解更多<span className="sr-only">, 网格模板列</span>
        </Link>
        <div className="mt-10">
          <Tabs
            tabs={tabs}
