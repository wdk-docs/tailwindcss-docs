...
import Demo from '@/components/blog/ComboboxDemo'
import ReactSnippet from './snippets/react.md'
import VueSnippet from './snippets/vue.md'

export const meta = {
  title: '无头 UI v1.5: 有组合框的那个',
...
[![Headless UI v1.5](./banner.jpg)](https://headlessui.dev)
...
[![Command palette from Tailwind UI](./command-palette.jpg)](https://tailwindui.com/components/application-ui/navigation/command-palettes)
