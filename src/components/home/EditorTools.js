  ...
  return (
    <section id="editor-tools">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-sky-500">编辑器工具</Caption>
        <BigText>世界级的IDE集成。</BigText>
        <Paragraph as="div">
          <p>
            担心记住所有这些类名吗?vscode的顺风CSS智能感知扩展已经覆盖了你。
          </p>
          <p>
            获得智能自动补全建议，检查，类定义和更多，所有在您的编辑器，不需要配置。
          </p>
        </Paragraph>
        <Link href="/docs/intellisense" color="sky" darkColor="gray">
          了解更多<span className="sr-only">, 编辑器设置</span>
        </Link>
      </div>
      <GridLockup
        className="mt-10"
