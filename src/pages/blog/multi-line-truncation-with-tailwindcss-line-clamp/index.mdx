...
export const meta = {
  title: '多行截断与@tailwindcss/line-clamp',
...
<p className="lead">A few weeks back we released <a href="https://github.com/tailwindlabs/tailwindcss-line-clamp"><code>@tailwindcss/line-clamp</code></a>, an official Tailwind CSS plugin for truncating text to a specific number of lines.</p>
