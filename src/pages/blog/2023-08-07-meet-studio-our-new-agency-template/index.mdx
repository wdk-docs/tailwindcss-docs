...
export const meta = {
  title: '满足工作室:我们美丽的新机构网站模板',
  description: `我们刚刚发布了工作室-一个美丽的新机构网站模板，我们一直在为过去几个月的顺风UI工作。`,
...
我们刚刚发布了[Studio](https://tailwindui.com/templates/studio) — 一个美丽的新机构网站模板，我们一直在为过去几个月的顺风UI工作。
