...
import ReactExample1 from './snippets/react-1.md'
import ReactExample2 from './snippets/react-2.md'
import ReactExample3 from './snippets/react-3.md'
import ReactExample4 from './snippets/react-4.md'
import VueExample1 from './snippets/vue-1.md'
import VueExample2 from './snippets/vue-2.md'
import VueExample3 from './snippets/vue-3.md'
import VueExample4 from './snippets/vue-4.md'

export const meta = {
  title: '无头 UI v1.4: 有标签的手机',
...
[![Headless UI v1.4](./banner.jpg)](https://headlessui.dev)
...
[![Product details interface design from Tailwind UI Ecommerce.](./ecommerce-screenie.jpg)](https://tailwindui.com/ecommerce)
