  ...
  return (
    <section id="state-variants">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-blue-500">状态变量</Caption>
        <BigText>
          <Widont>悬停和聚焦状态?我们抓到他们了。</Widont>
        </BigText>
        <Paragraph>
         想要在悬停时设置样式? 坚持 <InlineCode>hover:</InlineCode> 在课程开始时，你想添加。
         适用于 <InlineCode>focus</InlineCode>,{' '}
          <InlineCode>active</InlineCode>, <InlineCode>disabled</InlineCode>,{' '}
          <InlineCode>focus-within</InlineCode>, <InlineCode>focus-visible</InlineCode>,
          甚至我们把自己想象成一个奇妙的状态 <InlineCode>group-hover</InlineCode>.
        </Paragraph>
        <Link href="/docs/hover-focus-and-other-states" color="blue" darkColor="gray">
          了解更多<span className="sr-only">，处理悬停、焦点和其他状态</span>
        </Link>
      </div>
      <GridLockup
