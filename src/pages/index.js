    ...
    <>
      <Head>
        ...
        <meta
          ...
          content="Tailwind CSS - Rapidly build modern websites without ever leaving your HTML."
        />
        <title>顺风CSS -快速建立现代网站，而无需离开你的HTML。</title>
      </Head>
          ...
          <figure>
            <blockquote>
              <p className="mt-6 max-w-3xl mx-auto text-lg">
                ...
                为什么传统的“语义类名”是CSS难以维护的原因，但事实是，在你真正尝试之前，你永远不会相信我。
                如果你能抑制住恶心的冲动，给它一个机会，我真的认为你会想知道你是如何用其他方式使用CSS的。
              </p>
            </blockquote>
            <figcaption className="mt-6 flex items-center justify-center space-x-4 text-left">
              ...
              <div>
                ...
                <div className="mt-0.5 text-sm leading-6">顺风CSS的创造者</div>
              </div>
            </figcaption>
          </figure>
        </section>
