  ...
  return (
    <section id="performance">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-sky-500">性能</Caption>
        <BigText>它很小——永远不要再发布未使用的CSS。</BigText>
        <Paragraph>
          在为生产构建时，顺风会自动删除所有未使用的CSS，这意味着您的最终CSS包可能是最小的。事实上，大多数顺风项目向客户交付的CSS少于10kB。
        </Paragraph>
        <Link href="/docs/optimizing-for-production" color="sky" darkColor="gray">
          了解更多<span className="sr-only">, 优化生产</span>
        </Link>
      </div>
      <GridLockup
        className="mt-14"
