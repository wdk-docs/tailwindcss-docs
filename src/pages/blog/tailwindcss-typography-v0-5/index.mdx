...
Check out the [documentation](/docs/typography-plugin#choosing-a-gray-scale) to learn more.
...
Check out the [element modifiers](/docs/typography-plugin#element-modifiers) documentation to learn more.
