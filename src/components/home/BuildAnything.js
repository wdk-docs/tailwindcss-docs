  ...
  return (
    <section id="build-anything">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        ...
        />
        <Caption className="text-pink-500 dark:text-pink-400">构建任何东西</Caption>
        <BigText>
          <Widont>你想做什么就做什么，说真的。</Widont>
        </BigText>
        <Paragraph>
          因为顺风是如此低级，它从不鼓励您设计相同的网站两次。
          即使使用相同的调色板和大小比例，也很容易在下一个项目中构建具有完全不同外观的相同组件。
        </Paragraph>
        <Link href="/docs/installation" color="pink" darkColor="gray">
          开始<span className="sr-only">, 安装</span>
        </Link>
        <div className="mt-10">
          <Tabs
