...
<figure>
  <Img src={jamesWorkExamples.src} alt="Examples of James' previous work" />
  <figcaption>Some of James' awesome work from his <a href="https://dribbble.com/james">Dribbble profile</a>.</figcaption>
</figure>
...
<figure>
  <Img src={tailwindUiExamples.src} alt="Designs James created for Tailwind UI" />
