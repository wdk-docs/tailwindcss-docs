...
To get the most out of Tailwind, you need a build step. It's the only way to be able to customize your [`tailwind.config.js`](/docs/configuration) file, extract components with [`@apply`](/docs/functions-and-directives#apply), or include [plugins](/docs/plugins).
